...
import next.controller.qna.ShowListController;
...
public class RequestMapping {
	...
	void initMapping() {
		...
		mappings.put("/qna/form", new LoginForwardController("/qna/form.jsp"));
		mappings.put("/qna/reform", new LoginForwardController("/qna/reform.jsp"));
		...
		mappings.put("/api/qna/list", new ShowListController());
